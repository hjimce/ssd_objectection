...
import stat
import subprocess
data_root_dir = "./data/my_data/lmdb"
train_data = data_root_dir + "/train_lmdb"
test_data = data_root_dir + "/test_lmdb"
num_classes = 3
caffe_root='./caffe'
...
def add_extra_layers(net, use_batchnorm=True, lr_mult=1):
    ...
    # TODO(weiliu89): Construct the name using the last labayer to avoid duplication.
    # 10 x 10
    out_layer = "conv6_1"
