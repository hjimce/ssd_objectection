...
# load label map file
labelmap_file = 'data/my_data/labelmap_kitti.prototxt'
...
model_weights = 'models/VGGNet/KITTI/SSD_300x300/VGG_KITTI_SSD_300x300_iter_67789.caffemodel'
...
detect_image = 'test_image/HLG00034.jpg'
